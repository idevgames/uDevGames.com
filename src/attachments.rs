use crate::{ db::DbPool, models::Attachment, };
...
pub async fn get_attachment(
    pool: State<'_, DbPool>, attachment_storage: State<'_, AttachmentStorage>,
    id: i32, _name: String
    ...
    let attachment = match Attachment::find_published_by_id(&conn, id) {
        Ok(attachment) => match attachment {
            ...
            None => return Err(GetAttachmentError::AttachmentNotFound(
